...
from forms import LoginForm, RegisterForm, CreatePostForm, CommentForm, CreateContactForm
...
def send_mail(mail, message, numero, nom):
    ...
    my_email = "ghassen.boukraia@edu.isetcom.tn"
    password = "ivup belu rehe jyom"
